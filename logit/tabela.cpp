  ...
  ofstream of(filename);
      for(int i=0; i<qosoby; i++) {
	    ...
	    if(o.commits_self_fork > 750) continue;
          ...
          if(version == 1) kol(o.forked, "dep");
          if(version == 2) kol(o.forked_pr, "dep");
          if(version == 3) kol(o.forked_number, "dep");
          ...
          kol(o.email, "email")
          kol(o.site, "site")
          kol(year == 2009, "year2009")
          kol(year == 2010, "year2010")
          kol(year == 2011, "year2011")
          kol(year == 2012, "year2012")
          kol(year == 2013, "year2013")
          kol(year == 2014, "year2014")
